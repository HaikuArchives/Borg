...
#define CALOBJ_H
/*
 * I am not porting libgnome - Riegger
 * #include <libgnome/libgnome.h>
 */
#include "gnome-defs.h" /* added for the BEGIN_GNOME_DECLS and END_GNOME_DECLS - Riegger */
#include "glib.h"
...
typedef struct {
	...
	char          *classtype;       /* originally , this was char *class; the c++ 
								 * file that included it did not like it - Riegger
          						 */
	...
	int newx;				/* Originally int new, changed to get along with c++ - Riegger */
