...
ColorStringView::ColorStringView(BRect frame,const char *name,const char *text,
	uint32 resizingMode,uint32 flags):BStringView(frame,name,text,resizingMode,flags){

}
void
ColorStringView::AttachedToWindow(){
}