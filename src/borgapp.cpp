...
const char *APP_SIGNATURE = "application/x-vnd.Non-BORG, Be Organizer";



BorgApp::BorgApp():BApplication(APP_SIGNATURE){
	BRect windowRect;
	windowRect.Set(50,50,649,499);
	new BOrganizer(windowRect);	
